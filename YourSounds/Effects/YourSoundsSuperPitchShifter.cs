...
public class YourSoundsSuperPitchShifter : YourSoundsEffect
{
    int bufsize;
    float xfade;
    int bufloc0;
    ...
    public YourSoundsSuperPitchShifter(float pitchAdjustCents = 0, float pitchAdjustSemitones = 5, float pitchAdjustOctaves = 0, float windowSizeMs = 50, float overlapSizeMs = 20, float wetMixDb = 0, float dryMixDb = -120, bool filterValue = true)
    {
