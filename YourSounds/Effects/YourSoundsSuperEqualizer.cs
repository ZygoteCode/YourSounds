...
public class YourSoundsSuperEqualizer : YourSoundsEffect
{
    float db2log;
    float pi;
    float halfpi;
    ...
    public YourSoundsSuperEqualizer(float lowFrequenciesDrivePercent = 0, float lowFrequenciesGainDb = 0, float middleFrequenciesDrivePercent = 0, float middleFrequenciesGainDb = 0, float highFrequenciesDrivePercent = 0, float highFrequenciesGainDb = 0, float lowMiddleFrequencyHz = 240, float middleHighFrequencyHz = 2400)
    {
